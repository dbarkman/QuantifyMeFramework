...
/**
 * QuantifyMeProperties.class.php
 * Description:
 *
 */

class QuantifyMeProperties extends Properties
{
	private $_propertiesFile;
	const PROP_LOGFILE = "quantifyme.log.file";
	const PROP_LOGLEVEL = "quantifyme.log.level";

	public function __construct()
	{
		$this->_propertiesFile = dirname(__FILE__) . '/../config/quantifyme.properties';
